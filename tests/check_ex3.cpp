...
TEST_CASE("Check ex3 empty", "[compare_output]")
{
    test_text_input("test_ex3", "empty_input.txt", "empty_actual.txt", "empty_output.txt");
}

TEST_CASE("Check ex3 one line", "[compare_output]")
{
    test_text_input("test_ex3", "one_line_input.txt", "one_line_actual.txt", "one_line_output.txt");
}

TEST_CASE("Check ex3 multiple lines", "[compare_output]")
{
    test_text_input("test_ex3", "multiple_line_input.txt", "multiple_line_actual.txt", "multiple_line_output.txt");
}

TEST_CASE("Check ex3 spaces and tabs", "[compare_output]")
{
    test_text_input("test_ex3", "spaces_and_tabs_input.txt", "spaces_and_tabs_actual.txt", "spaces_and_tabs_output.txt");
}